...
<div class="jumbotron text-center">
        <h1>Aeronation.com</h1> 
        <p>Your Dream TO Fly</p> 
</div>
...
curl_setopt($curl, CURLOPT_POSTFIELDS, "apikey=[povided-api-key]&secret=[provided-secret-key]&usetype=[stage or prod]");// post data
